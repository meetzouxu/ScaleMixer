...
def main():
    ...
    parser = argparse.ArgumentParser(description='UMixer')
    ...
    parser.add_argument('--model_id', type=str,
                        default='ETTm2_96', help='model id')

    parser.add_argument('--model', type=str,  default='UMixer',
                        help='model name, options: [Autoformer, TimesNet, UMixer]')
    # data loader
    ...
    parser.add_argument('--fft_k', type=int, default=2, help='FFT for period result')
    ...
    parser.add_argument('--learning_rate', type=float, default=0.0015, help='optimizer learning rate')
